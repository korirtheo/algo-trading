...
# --- STRATEGY CONFIG ---
GREEN_CANDLE_MIN_BODY_PCT = 8.0  # First candle body >= 8% (big momentum)
GREEN_CANDLE_MAX_BODY_PCT = 999  # No cap
MIN_GAP_PCT = 10.0               # Gap filter (>10%)
TARGET_PCT = 7.0                 # Sell 100% at +7%
STOP_PCT = 0                     # No price stop — time-based exit instead
TIME_LIMIT_MINUTES = 15          # Sell everything that hasn't hit target after 15 min
...
REQUIRE_2ND_NEW_HIGH = False     # No new high requirement
